...
var CLI_CMD = 'exec';
var COMMAND = `tools exec ${'[options] [--] <cmd> [args...]'.yellow}`;
var DESCRIPTION = `Run a given command in ${buildPack._cwd.yellow}.`;
var USAGE = `Usage:
  ${COMMAND.bold}
Description:
  ${DESCRIPTION}`;
...
exports.handler = function (opts) {
  ...
  childProcess.spawn(opts.args[0], opts.args.slice(1), options).on('exit', function (code, signal) {
