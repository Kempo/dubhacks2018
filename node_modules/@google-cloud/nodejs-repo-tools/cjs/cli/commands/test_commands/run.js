...
var CLI_CMD = 'run';
var TEST_CMD = buildPack.config.test.run.cmd;
var TEST_ARGS = buildPack.config.test.run.args;
var TEST_CMD_STR = `${TEST_CMD} ${TEST_ARGS.join(' ')}`.trim();
var COMMAND = `tools test ${CLI_CMD} ${'[options] [--] [args...]'.yellow}`;
var DESCRIPTION = `Run ${TEST_CMD_STR.bold} in ${buildPack._cwd.yellow}.`;
var USAGE = `Usage:
  ${COMMAND.bold}
Description:
  ${DESCRIPTION}
